              ...
              this.state.titles.map((item, index) => {
                return <NavLink key={index} to={{
                  ...
                  <div className={styles['table-item']}>
                    <span style={{fontSize: '0.14rem'}}> {item.name} </span>
                  </div>
                </NavLink>
              })
            }
            <span className={styles['btn']} onClick={this.isShow.bind(this)}>
                <svg t="1561381860449" className="icon" viewBox="0 0 1024 1024" version="1.1"
                     xmlns="http://www.w3.org/2000/svg" p-id="1986" width="24" height="24">
                    <path
        ...
        <div className='List' style={{display: this.state.display}}>
          ...
          <p className="jiantou">
                <span onClick={this.isHide.bind(this)}>
                    <svg t="1561384959190" className="icon" viewBox="0 0 1024 1024" version="1.1"
                         xmlns="http://www.w3.org/2000/svg" p-id="2783" width="24" height="24">
                        <path
                          d="M511.700683 319.596945 191.917496 639.424134 319.830771 639.424134 511.700683 447.304536 703.570595 639.424134 831.48387 639.424134Z"
                          p-id="2784"></path>
                    </svg>
                </span>
          </p>
